...
var chooseApp = function(e) {
	// TODO: only auth if no previous constructionApp or it has changed.
	Ti.App.Properties.setString("constructionApp", e.source.text);
...
// TODO: do below only after checking if we have also already gotten oauth token.
